  ...
  <div class="modal-dialog">
	...
	<div class="modal-body">
			 <div class="form-horizontal" >
				...
				<div class="form-group">
					<div class="col-sm-10">
					<button class="btn btn-success btn-block" onclick="window.location.href='playermail.php'">玩家后台</button>
					<button class="btn btn-warning btn-block" onclick="window.location.href='playeredit2.php'">修改密码</button>
